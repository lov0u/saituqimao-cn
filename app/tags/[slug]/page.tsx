    ...
    <>
      <section className="bg-gradient-to-r from-brand-700 to-brand-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90">共 {total} 篇相关文章</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-neutral-50 min-h-[400px]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm text-neutral-500 mb-8">
            ...
            <span>/</span>
            <Link href="/tags" className="hover:text-brand-600">标签</Link>
            <span>/</span>
          ...
          <div className="mt-8 text-center">
            <Link href="/tags" className="inline-flex items-center gap-2 text-brand-600 hover:text-brand-700 font-medium">
